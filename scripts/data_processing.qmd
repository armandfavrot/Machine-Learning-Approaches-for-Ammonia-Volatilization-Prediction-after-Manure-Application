...
# save (processed_data/data_ml, file = "data_ml.Rdata")
...
data_scenarios_alfam2 = data_scenarios %>% 
    ...
    pivot_longer (cols = c (10 : 27), names_to = c (".value", "time"), names_pattern = "(.+)_(.+)") %>%
