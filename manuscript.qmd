...
```{r, include = FALSE}
png (file = "figures/Figure_2_slides.png", width = 1000, height = 700)
Figure_2 + theme (plot.margin = ggplot2::margin (70, 80, 10, 20))
dev.off()
```
...
```{r}
res_scenarios_paper1 = data_scenarios

save (res_scenarios_paper1, file = "~/Bureau/res_scenarios_paper1.Rdata")
```
...
plot_shap_rf_2 = plot_shap_rf +
    ...
    label.padding = unit(0.8, "lines"), fontface = "bold", x = 40.8, y = 1.5, fill = "#000080", color = "white") +
    xlim (c (- 18, 45)) +
    theme (legend.position = "none", 
...
plot_shap_xgboost_2 = plot_shap_xgboost +
    ...
    label.padding = unit(0.8, "lines"), fontface = "bold", x = 39.5, y = 1.5, fill = "#000080", color = "white") +
    xlim (c (- 18, 45)) + 
    theme (legend.position = "none", 
          plot.margin = unit (c (0, 0, 1, 0), "cm"),
...
```{r}
png (file = "figures/Figure_5_slides.png", width = 1400, height = 900)
do.call ("grid.arrange", 
         c (list(plot_shap_rf_2 + theme (plot.margin = ggplot2::margin (70, 70, 0, 40)), 
                 plot_shap_xgboost_2 + theme (plot.margin = ggplot2::margin (70, 70, 0, 40)), 
                 legend), 
            list(layout_matrix = as.matrix(c (1, 2, 3)),
                  heights = c (0.8, 1, 0.2))))
dev.off()
